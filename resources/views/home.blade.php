...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-xl-6">
                    <div class="ps-xxl-5 ms-xl-4 wow fadeInRight">
                        ...
                        <p class="mb-30">Notre plateforme connecte les clients à une communauté de chauffeurs qualifiés,
                            prêts à vous conduire où vous le souhaitez, quand vous le souhaitez. Avec notre système de
                            géolocalisation avancé, vous pouvez facilement trouver les chauffeurs disponibles à proximité,
                            garantissant ainsi des temps d'attente minimes et des trajets rapides.</p>
            ...
            <div class="row slider-shadow th-carousel" id="serviceSlide" data-slide-show="3" data-lg-slide-show="3"
                ...
                <div class="col-md-6 col-lg-4 col-xl-3  ">
                    <div class="service-item wow fadeInUp"
                        data-bg-src="{{ asset('urbanhaul/assets/img/transport4.jpg') }}')}}">
                        ...
                        <div class="service-item_content">
                            ...
                            <p class="service-item_text">Peu importe où vous êtes, nous vous mettons en relation avec les
                                agents les plus proches.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4 col-xl-3  ">
                    <div class="service-item wow fadeInUp"
                        data-bg-src="{{ asset('urbanhaul/assets/img/service/service_shape_1.jpg') }}')}}">
                        <div class="service-item_img">
                        ...
                        <div class="service-item_content">
                            ...
                            <p class="service-item_text">Vous avez besoin de transférer un colis ? Il suffit de nous
                                contacter.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4 col-xl-3  ">
                    <div class="service-item wow fadeInUp"
                        ...
                        <div class="service-item_content">
                            ...
                            <p class="service-item_text">Si vous souhaitez contribuer à simplifier le transport pour la
                                population, inscrivez-vous en tant qu'Agent. Le processus est simple et sans frais.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row slider-shadow th-carousel" data-slide-show="4" data-lg-slide-show="3" data-md-slide-show="2"
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="team-item wow fadeInUp">
                        <div class="team-img">
                            <img style="height: 250px;" src="{{ asset('urbanhaul/assets/img/profile1.jpg') }}"
                                alt="Team">
                        </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="team-item wow fadeInUp">
                        <div class="team-img">
                            <img style="height: 250px;" src="{{ asset('urbanhaul/assets/img/profile5.jpg') }}"
                                alt="Team">
                        </div>
                        <div class="team-item_content">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="team-item wow fadeInUp">
                        <div class="team-img">
                            <img style="height: 250px;" src="{{ asset('urbanhaul/assets/img/profile3.jpg') }}"
                                alt="Team">
                        </div>
                        <div class="team-item_content">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="team-item wow fadeInUp">
                        <div class="team-img">
                            <img style="height: 250px;" src="{{ asset('urbanhaul/assets/img/profile4.jpg') }}"
                                alt="Team">
                        </div>
                        <div class="team-item_content">
    ...
    <section class="download-area3 overflow-hidden space-top"
        data-bg-src="{{ asset('urbanhaul/assets/img/transport8.jpg') }}">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-7">
                    <div class="ps-xxl-5 ms-xl-5 wow fadeInRight">
                        <div class="title-area text-center text-xl-start">
                            ...
                            <h2 class="sec-title text-white">Optez pour UrbanHaul pour des trajets en ville simples, sûrs
                                et efficaces.</h2>
                        </div>
                            ...
                            <div class="counter-wrapper">
                                <div class="counter-card style2">
                                    <div class="counter-card_icon">
                                        <img src="{{ asset('urbanhaul/assets/img/icon/counter_2_1.svg') }}"
                                            alt="icon">
                                    </div>
                                ...
                                <div class="counter-card style2">
                                    <div class="counter-card_icon">
                                        <img src="{{ asset('urbanhaul/assets/img/icon/counter_2_2.svg') }}"
                                            alt="icon">
                                    </div>
                                ...
                                <div class="counter-card style2">
                                    <div class="counter-card_icon">
                                        <img src="{{ asset('urbanhaul/assets/img/icon/counter_2_3.svg') }}"
                                            alt="icon">
                                    </div>
                        ...
                        <div class="testi-item_wrapper">
                            <div class="testi-item_profile">
                                <div class="testi-item_img">
                                    <img src="{{ asset('urbanhaul/assets/img/testimonial/testi_3_4.jpg') }}"
                                        alt="Avater">
                                </div>
                            ...
                            <div class="testi-item_quote"><img src="{{ asset('urbanhaul/assets/img/icon/quote_2.svg') }}"
                                    alt="quote"></div>
                        </div>
