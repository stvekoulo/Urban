                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('profil.update') }}" method="POST"
                                        ...
                                        <div class="mb-3">
                                            <label for="whatsapp_link" class="form-label">Lien vers le compte
                                                WhatsApp</label>
                                            ...
                                            @error('whatsapp_link')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                            <small>Vous pouvez utiliser ce lien pour générer un lien vers votre profil
                                                WhatsApp : <a href="https://create.wa.link/" target="_blank">Générateur
                                                    de lien WhatsApp gratuit</a></small>
                                        </div>
                                        <div class="mb-3">
                                            <label for="national_id" class="form-label">Numéro d'identification (Carte
                                                nationale)</label>
