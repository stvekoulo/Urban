                    ...
                    @foreach ($agents as $agent)
                        <div class="col-md-4">
                            <div class="taxi-item style2">
                                ...
                                <h3 class="taxi-item_title"><a
                                        href="{{ route('agentdetail', ['id' => $agent->id]) }}">{{ $agent->name }}</a></h3>
                                <a href="{{ route('agentdetail', ['id' => $agent->id]) }}"
                                    class="th-btn fw-btn">Selectionner<i class="fa-regular fa-arrow-right ms-2"></i></a>
                            </div>
                        </div>
                    @endforeach
                </div>
